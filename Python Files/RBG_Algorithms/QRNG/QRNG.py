...
""" 
  ...
  PART 2: GENERATE set of SEQUENCES BY EXTRACTING COUNT DIRECTORY WITH AN ADVANCED VERSION...
...
buffers = ['']*100              # it is for multiplication with iterations to generate seq. length
