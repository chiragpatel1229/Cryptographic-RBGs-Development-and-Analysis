...
'''
-> This algorithm takes carefully consider quantum random bits using hash.sha-3 function to produce a entropy values 
...
-> IBM-backend can be changed in Section 1.4 and the user API token should be loaded in the separate file name 
    'Synthetic_API_token.txt' for the convenience. Also the Backend provider can be a real quantum device check section 1.4.
...
class SyntheticRBG(object):
    ...
    def __init__(self, Token_file_path):
        ...
        # create a very long integer to initialize the entropy pool
    ...
    def _update(self):
        # print("Update: The entropy and the seed value is being updated.\n")
        ...
        if len(self.entropy) < 1024:                     # use the system entropy bcz the generating quantum bits takes time
            ...
            # print(f"Update: Added {len(local_bits)} bits from local entropy pool.\n")   # inform about the added bits
        ...
        # print(f"Update: Remaining bits in entropy pool: {len(self.entropy)} \n")
    ...
    def Refill_entropy(self):
        # print("Entropy Refill process is started!\n")

        q_bits = self.Quantum_circuit()             # get the quantum generated random bit string
        # print(f"Received initial {len(q_bits)} bits from a quantum circuit!\n")
        ...
        # print(f"Refill: Total of {len(self.entropy)} bits available in the entropy pool.")
        # print("Entropy pool is Refilled!\n")
    ...
    def Quantum_circuit(self):
        ...
        # print("Quantum circuit: Provider and Backend is ready!\n")
        ...
        # print("Quantum circuit is executed!\n")
        ...
        for i in range(3):
            ...
            if len(keys) >= 5:
                # print(f"Found enough Keys in {i} iteration!\n")
        ...
        # print(f"Quantum circuit: {len(bits)} bits generated successfully!\n")
