...
def Mako(seq_):
    ...
    for sequence in seq_:
        min__ = markov_test(sequence)         # collect only normalised gaps
        all_mako.append(min__)   # set them with a descending order to ease the further part
    return all_mako
...
file_names = ['../RBG_data_files/M_sequences.txt']
